                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4> Email </h4>
                                    <a href="mailto:rosskugler@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                        rosskugler@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4> Phone </h4>
                                    <a href="tel:+14255122710" className="text-muted-foreground hover:text-primary transition-colors">
                                        +1 (425) 512-2710
                                    </a>
                                </div>
                            </div>
